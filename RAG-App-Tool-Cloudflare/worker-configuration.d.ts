/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4e472a0756f73154120c00be04ed4bf8)
// Runtime types generated with workerd@1.20251008.0 2025-10-12 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		D1_DATABASE: string;
		CLOUD_FLARE_ORIGIN_CORS: string;
		CLOUD_FLARE_ACCOUNT_ID: string;
		CLOUD_FLARE_WORKER_AI_API_KEY: string;
		TOP_K_VALUE: string;
		CHUNK_SIZE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYSTEM_PROMPT" | "VECTORIZE_INDEX" | "D1_DATABASE" | "CLOUD_FLARE_ORIGIN_CORS" | "CLOUD_FLARE_ACCOUNT_ID" | "CLOUD_FLARE_WORKER_AI_API_KEY" | "TOP_K_VALUE" | "CHUNK_SIZE" | "CHUNK_OVERLAP" | "LLM_CHAT_MODEL" | "LLM_EMBED_MODEL">> {}
}
